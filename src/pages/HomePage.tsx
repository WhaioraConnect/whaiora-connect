          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
              ...
              {[{
                ...
                return (
                  <div key={i} className="group bg-card border-2 border-secondary/30 rounded-xl overflow-hidden hover:border-secondary hover:shadow-xl transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[{
                ...
                <Link
                  key={i}
                  to={tip.href}
                  className="bg-card rounded-xl border border-border hover:border-primary hover:shadow-lg transition-all group overflow-hidden"
                >
                  <div className="aspect-video relative overflow-hidden">
                    <img 
                      src={tip.image} 
        ...
        <section className="py-20 bg-gradient-to-br from-primary via-primary to-secondary text-white relative overflow-hidden">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Begin Your Wellness Journey?</h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/register"
                  className="px-8 py-4 bg-secondary text-secondary-foreground rounded-lg font-semibold hover:bg-white transition-all shadow-lg"
                >
                  Become a Provider
                </Link>
